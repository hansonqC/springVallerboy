...
public class VehicleController {
    ...
    public String vehicleGet(Locale locale, Model model){
    ...
    public String vehiclePost(@ModelAttribute("vehicleForm") @Valid VehicleForm form, BindingResult result, Model model){
